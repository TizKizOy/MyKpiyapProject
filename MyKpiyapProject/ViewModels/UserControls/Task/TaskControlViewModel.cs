    ...
    public class TaskControlViewModel : INotifyPropertyChanged
    {
        ...
        private void LoadDataTask()
        {
            if (SelectedTask != null)
            {
                ...
                SecondControl = new ViewingTask(currentTask, RefreshData)
                {
                    DataContext = new ViewingTaskControlViewModel(currentTask, RefreshData)
                };
        ...
        private void ApplyFilters()
        {
            ...
            {
                filtered = filtered.Where(e => e.Priority == _selectedPriority);
            }
            ...
            if (!string.IsNullOrEmpty(SearchText))
            {
                ...
                filtered = filtered.Where(e =>
                    ...
                    e.Priority.ToLower().Contains(searchTextLower));
            }
        ...
        private void FilterByPriority(object priority)
        {
